...
package democicd.first_job_0_1;
 ...
 * Description: <br>
 * 
 * @author Belghuith, Kadhem
 * @version 8.0.1.20220923_1236-patch
 * @status
 */
public class first_job implements TalendJob {
	static {
		System.setProperty("TalendJob.log", "first_job.log");
	}

	private static org.apache.logging.log4j.Logger log = org.apache.logging.log4j.LogManager.getLogger(first_job.class);
	...
	private final String projectName = "DEMOCICD";
					...
					class BytesLimit65535_tSetGlobalVar_1 {
						public void limitLog4jByte() throws Exception {
							...
							log4jParamters_tSetGlobalVar_1.append(
									"VARIABLES" + " = " + "[{VALUE=" + ("\"myValue\"") + ", KEY=" + ("\"var\"") + "}]");
							log4jParamters_tSetGlobalVar_1.append(" | ");
							if (log.isDebugEnabled())
	...
	public static void main(String[] args) {
		...
		if (exitCode == 0) {
			log.info("TalendJob: 'first_job' - Done.");
		}
	...
	public int runJobInTOS(String[] args) {
		...
		getjobInfo();
		log.info("TalendJob: 'first_job' - Start.");
		...
		org.slf4j.MDC.put("_jobRepositoryId", "_hC02sMe_Ee2tXoe2dgLtzw");
		org.slf4j.MDC.put("_compiledAtTimestamp", "2023-03-21T08:10:06.048336100Z");
		...
		try {
			...
			java.io.InputStream inContext = first_job.class.getClassLoader()
					.getResourceAsStream("democicd/first_job_0_1/contexts/" + contextStr + ".properties");
			if (inContext == null) {
		...
		log.info("TalendJob: 'first_job' - Started.");
		...
		log.info("TalendJob: 'first_job' - Finished - status: " + status + " returnCode: " + returnCode);
...
/************************************************************************************************
 * 47029 characters generated by Talend Cloud Data Management Platform on the 21
 * mars 2023 à 09:10:06 WAT
 ************************************************************************************************/